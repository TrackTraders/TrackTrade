        ...
        return (
            <div className="signuppage">
                ...
                <div className="signup-social">
                    <a href="/auth/google" role="button" className="signup-social-google-button">
                        ...
                        <span className="signup-social-google-button__text">Log In with Google</span>
                    </a>
                    <a href="/auth/facebook" role="button" className="signup-social-facebook">Log In with Facebook</a>
                </div>
                </div>
            </div>
        )
