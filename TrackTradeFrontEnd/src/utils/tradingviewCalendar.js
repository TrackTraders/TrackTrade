!(function () {
    ...
    new (class extends class {
        ...
        filterRawSettings(t) {
            ...
            return (
                Object.keys(t).forEach((i) => {
                    -1 !== this.propertiesToWorkWith.indexOf(i) &&
                        (e[i] = t[i]);
                }),
                e
            );
        ...
        _replaceScript(e) {
            const { scriptEnv: i, scriptHost: r, scriptElement: s } = e;
            this.script = s;
            ...
            (this.hasCopyright = a || c),
                ...
                (o && this._isValidSettings()) ||
                    ...
                    (this.settings = this.filterRawSettings(
        ...
        _iframeSrcBase(t, e) {
            ...
            let r = this.useWidgetHostForProduction
                ? i
